      ...
      <div class="container">
        ...
        <div class="card-deck mb-3 text-center">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <h1 class="card-title pricing-card-title">$25 <small class="text-muted">/ week</small></h1>
              <ul class="list-unstyled mt-3 mb-4">
                <li>Instagram & Facebook</li>
                <li>3 Posts Weekly</li>
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <h1 class="card-title pricing-card-title">$40 <small class="text-muted">/ week</small></h1>
              <ul class="list-unstyled mt-3 mb-4">
                <li>Instagram & Facebook</li>
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              <h1 class="card-title pricing-card-title">$60 <small class="text-muted">/ week</small></h1>
              <ul class="list-unstyled mt-3 mb-4">
                <li>Instagram & Facebook</li>
