					...
					<ul class="timeline">
						...
						<li>
							...
							<div class="timeline-panel">
								...
								<div class="timeline-body">
									<p>We have expanded our services, hence providing our customers with more solutions. We are now offering Digital Marketing & SEO services to help increase traffic and optimise engagement.</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted">
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section-heading text-uppercase">The Team Behind Lucid Media</h2>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-8 mx-auto">
							<div class="modal-body">
								...
								<img class="img-fluid d-block mx-auto" src="img/portfolio/9.png" alt="">
