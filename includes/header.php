<head>
    ...
    <link rel="manifest" href="../imag/logos/site.webmanifest">
    <!-- Bootstrap core CSS -->
    ...
    <meta name="google-site-verification" content="eMAVk-IUJZhMDoMhQ693lHJTr3LdOXq0ENKpnVRz2vU" />
    <!-- Navigation Bar-->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container animated animatedFadeInUp fadeInUp"> <a class="navbar-brand js-scroll-trigger"
                href="index.php#page-top">Lucid Media</a>
            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse"
                data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false"
                aria-label="Toggle navigation"><i style="font-size:20px;" class="fas fa-bars"></i>
            </button>
